...
DROP TABLE "SYSTEM"."DRZAVA";
DROP TABLE "SYSTEM"."HELP";
DROP TABLE "SYSTEM"."KLIJENT";
DROP TABLE "SYSTEM"."KONTAKTOSOBA";
...
DROP TABLE "SYSTEM"."NALOGZATRANSPORT";
DROP TABLE "SYSTEM"."NALOGZAUSKLADISTENJE";
DROP TABLE "SYSTEM"."OL$";
DROP TABLE "SYSTEM"."OL$HINTS";
DROP TABLE "SYSTEM"."OL$NODES";
DROP TABLE "SYSTEM"."PREVOZNIK";
DROP TABLE "SYSTEM"."RACUN";
DROP TABLE "SYSTEM"."RADNIK";
...
DROP TABLE "SYSTEM"."ROBA";
DROP TABLE "SYSTEM"."SKLADISTE";
DROP TABLE "SYSTEM"."SQLPLUS_PRODUCT_PROFILE";
DROP TABLE "SYSTEM"."STAVKANALTR";
DROP TABLE "SYSTEM"."STAVKANALTR_DETALJI";
DROP TABLE "SYSTEM"."STAVKAOTPR";
DROP TABLE "SYSTEM"."STAVKARAC";
DROP TABLE "SYSTEM"."STAVKATERET";
DROP TABLE "SYSTEM"."STAVKATRUG";
DROP TABLE "SYSTEM"."TERET";
DROP TABLE "SYSTEM"."TRANSPORTNIUGOVOR";
DROP TABLE "SYSTEM"."ULICA";
DROP TABLE "SYSTEM"."VOZILO";
...
DROP SEQUENCE "SYSTEM"."AUTO_INCREMENT_KLIJENT";
DROP SEQUENCE "SYSTEM"."AUTO_INCREMENT_MESTO";
DROP SEQUENCE "SYSTEM"."AUTO_INCREMENT_RADNIK";
DROP SEQUENCE "SYSTEM"."AUTO_INCREMENT_ULICA";
...
DROP VIEW "SYSTEM"."STAVKANALTR_VIEW";
DROP PACKAGE "SYSTEM"."DBMS_REPCAT_AUTH";
DROP PACKAGE "SYSTEM"."RADNIKPOZ";
DROP PACKAGE "SYSTEM"."STAVKAR";
DROP PACKAGE BODY "SYSTEM"."DBMS_REPCAT_AUTH";
DROP PROCEDURE "SYSTEM"."ORA$_SYS_REP_AUTH";
DROP PROCEDURE "SYSTEM"."SUMASTAVKIRACUNA1";
DROP PROCEDURE "SYSTEM"."SUMASTAVKIRACUNA2";
DROP PROCEDURE "SYSTEM"."SUMASTAVKIRACUNA3";
DROP TYPE "SYSTEM"."REPCAT$_OBJECT_NULL_VECTOR";
DROP TYPE "SYSTEM"."ULICABROJ";
DROP TYPE "SYSTEM"."ZAPREMINA";
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Type ULICABROJ
--------------------------------------------------------

  CREATE OR REPLACE TYPE "SYSTEM"."ULICABROJ" AS OBJECT (
Ulica VARCHAR(20),
Broj NUMBER,
MEMBER FUNCTION vratiUlicu RETURN VARCHAR,
MEMBER FUNCTION vratiBroj RETURN NUMBER)
INSTANTIABLE NOT FINAL;

/
--------------------------------------------------------
--  DDL for Type ZAPREMINA
--------------------------------------------------------

  CREATE OR REPLACE TYPE "SYSTEM"."ZAPREMINA" AS OBJECT (kubni_metar NUMBER (9,2), MEMBER FUNCTION get_kubni_metar RETURN NUMBER)
INSTANTIABLE NOT FINAL;

/
--------------------------------------------------------
--  DDL for Sequence AUTO_INCREMENT_KLIJENT
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTO_INCREMENT_KLIJENT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 815 CACHE 100 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence AUTO_INCREMENT_MESTO
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTO_INCREMENT_MESTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 113 CACHE 100 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence AUTO_INCREMENT_RADNIK
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTO_INCREMENT_RADNIK"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 324 CACHE 100 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence AUTO_INCREMENT_ULICA
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTO_INCREMENT_ULICA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 337 CACHE 100 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DRZAVA" 
   (	"DRZID" NUMBER(*,0), 
	"NAZDRZ" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  DDL for Table KLIJENT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."KLIJENT" 
   (	"KID" NUMBER(*,0), 
	"PIB" NUMBER(*,0), 
	"NAZIVFIRME" VARCHAR2(35 BYTE), 
	"TELEFON" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table KONTAKTOSOBA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."KONTAKTOSOBA" 
   (	"KID" NUMBER, 
	"KONTAKTRB" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."MESTO" 
   (	"RBMESTA" NUMBER(*,0), 
	"DRZID" NUMBER(*,0), 
	"NAZIVM" VARCHAR2(30 BYTE), 
	"POSTA" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  DDL for Table NALOGZATRANSPORT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."NALOGZATRANSPORT" 
   (	"NALID" NUMBER(*,0), 
	"DATUM" DATE, 
	"RID" NUMBER(*,0), 
	"KID" NUMBER(*,0), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table NALOGZAUSKLADISTENJE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" 
   (	"BRNAL" NUMBER(*,0), 
	"RID" NUMBER(*,0), 
	"SKLADRB" NUMBER(*,0), 
	"UGID" NUMBER(*,0)
...
--------------------------------------------------------
--  DDL for Table PREVOZNIK
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PREVOZNIK" 
   (	"PID" NUMBER(*,0), 
	"NAZIVFIRME" VARCHAR2(35 BYTE), 
	"TELEFON" NUMBER(*,0), 
	"RBADRESE" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."RACUN" 
   (	"BRRAC" NUMBER(*,0), 
	"DATUM" DATE, 
	"RADNIK" VARCHAR2(20 BYTE), 
	"UKUPNACENA" NUMBER(10,2) DEFAULT 0, 
	"KID" NUMBER, 
	"NAZIVFIRME" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."RADNIK" 
   (	"RID" FLOAT(126), 
	"IME" VARCHAR2(15 BYTE), 
	"PREZIME" VARCHAR2(25 BYTE), 
	"TELEFON" FLOAT(126), 
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table STAVKANALTR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."STAVKANALTR" 
   (	"STAVKANT" NUMBER, 
	"NALID" NUMBER, 
	"KONTAKTUTOV" VARCHAR2(40 BYTE), 
	"KONTAKTISTOV" VARCHAR2(40 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table STAVKANALTR_DETALJI
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."STAVKANALTR_DETALJI" 
   (	"STAVKANT" NUMBER, 
	"NALID" NUMBER, 
	"OSIGURANJE" VARCHAR2(20 BYTE), 
	"ROBAID" NUMBER, 
	"RBULICE" NUMBER, 
	"RBMESTA" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table STAVKAOTPR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."STAVKAOTPR" 
   (	"STAVKAO" NUMBER(*,0), 
	"OTPRBR" NUMBER(*,0), 
	"ROBAID" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table STAVKARAC
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."STAVKARAC" 
   (	"STAVKAR" NUMBER(*,0), 
	"BRRAC" NUMBER(*,0), 
	"USLUGA" VARCHAR2(50 BYTE), 
	"CENA" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table STAVKATERET
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."STAVKATERET" 
   (	"STAVKAT" NUMBER(*,0), 
	"POSILJKA" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table STAVKATRUG
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."STAVKATRUG" 
   (	"STAVKATU" NUMBER(*,0), 
	"UGID" NUMBER(*,0), 
	"DATPRIJEMA" DATE, 
	"DATDOSTAVE" DATE, 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TRANSPORTNIUGOVOR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TRANSPORTNIUGOVOR" 
   (	"UGID" NUMBER(*,0), 
	"DATUM" DATE, 
	"VOZAC" VARCHAR2(40 BYTE), 
	"RID" NUMBER(*,0), 
	"PID" NUMBER(*,0), 
	"NALID" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."VOZILO" 
   (	"REGBR" VARCHAR2(8 BYTE), 
	"PID" NUMBER(*,0), 
	"TIPVOZILA" VARCHAR2(25 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  DDL for View STAVKANALTR_VIEW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."STAVKANALTR_VIEW" ("STAVKANT", "NALID", "KONTAKTUTOV", "KONTAKTISTOV", "OSIGURANJE", "ROBAID", "RBULICE", "RBMESTA") AS 
  SELECT SN.StavkaNT, SN.NalId, SN.KontaktUtov, SN.KontaktIstov, SND.Osiguranje, SND.RobaId, SND.RbUlice, SND.RbMesta
FROM StavkaNalTr SN, StavkaNalTr_Detalji SND
WHERE 
SN.StavkaNT = SND.StavkaNT
AND
SN.NalId = SND.NalId;
REM INSERTING into SYSTEM.ADRESA
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.DRZAVA
SET DEFINE OFF;
...
REM INSERTING into SYSTEM.KLIJENT
SET DEFINE OFF;
REM INSERTING into SYSTEM.KONTAKTOSOBA
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MESTO
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.NALOGZATRANSPORT
SET DEFINE OFF;
REM INSERTING into SYSTEM.NALOGZAUSKLADISTENJE
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PREVOZNIK
SET DEFINE OFF;
REM INSERTING into SYSTEM.RACUN
SET DEFINE OFF;
REM INSERTING into SYSTEM.RADNIK
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ROBA
SET DEFINE OFF;
REM INSERTING into SYSTEM.SKLADISTE
SET DEFINE OFF;
REM INSERTING into SYSTEM.SQLPLUS_PRODUCT_PROFILE
SET DEFINE OFF;
REM INSERTING into SYSTEM.STAVKANALTR
SET DEFINE OFF;
REM INSERTING into SYSTEM.STAVKANALTR_DETALJI
SET DEFINE OFF;
REM INSERTING into SYSTEM.STAVKAOTPR
SET DEFINE OFF;
REM INSERTING into SYSTEM.STAVKARAC
SET DEFINE OFF;
REM INSERTING into SYSTEM.STAVKATERET
SET DEFINE OFF;
REM INSERTING into SYSTEM.STAVKATRUG
SET DEFINE OFF;
REM INSERTING into SYSTEM.TERET
SET DEFINE OFF;
REM INSERTING into SYSTEM.TRANSPORTNIUGOVOR
SET DEFINE OFF;
REM INSERTING into SYSTEM.ULICA
SET DEFINE OFF;
REM INSERTING into SYSTEM.VOZILO
SET DEFINE OFF;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index STAVKANALTR_DETALJI_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."STAVKANALTR_DETALJI_PK" ON "SYSTEM"."STAVKANALTR_DETALJI" ("STAVKANT", "NALID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index STAVKANALTTR_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."STAVKANALTTR_PK" ON "SYSTEM"."STAVKANALTR" ("STAVKANT", "NALID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C0011058" ON "SYSTEM"."KLIJENT" ("KID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index KOSOBA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."KOSOBA_PK" ON "SYSTEM"."KONTAKTOSOBA" ("KID", "KONTAKTRB") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKADRESA
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKADRESA" ON "SYSTEM"."ADRESA" ("RBADRESE", "RBULICE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKDRZAVA
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKDRZAVA" ON "SYSTEM"."DRZAVA" ("DRZID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKMEST
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKMEST" ON "SYSTEM"."MESTO" ("RBMESTA", "DRZID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKNALZATR
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKNALZATR" ON "SYSTEM"."NALOGZATRANSPORT" ("NALID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKNALZAUSKL
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKNALZAUSKL" ON "SYSTEM"."NALOGZAUSKLADISTENJE" ("BRNAL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKPREV
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKPREV" ON "SYSTEM"."PREVOZNIK" ("PID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKRACUN
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKRACUN" ON "SYSTEM"."RACUN" ("BRRAC") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKRADNIK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKRADNIK" ON "SYSTEM"."RADNIK" ("RID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKROBA
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKROBA" ON "SYSTEM"."ROBA" ("ROBAID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKSKLAD
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKSKLAD" ON "SYSTEM"."SKLADISTE" ("SKLADRB") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKSTOTPR
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKSTOTPR" ON "SYSTEM"."STAVKAOTPR" ("STAVKAO", "OTPRBR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKSTRAC
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKSTRAC" ON "SYSTEM"."STAVKARAC" ("STAVKAR", "BRRAC") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKSTTERET
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKSTTERET" ON "SYSTEM"."STAVKATERET" ("STAVKAT", "POSILJKA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKSTTRUG
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKSTTRUG" ON "SYSTEM"."STAVKATRUG" ("STAVKATU", "UGID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKTERET
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKTERET" ON "SYSTEM"."TERET" ("POSILJKA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKTRUG
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKTRUG" ON "SYSTEM"."TRANSPORTNIUGOVOR" ("UGID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKULICA
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKULICA" ON "SYSTEM"."ULICA" ("RBULICE", "RBMESTA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PKVOZILO
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PKVOZILO" ON "SYSTEM"."VOZILO" ("REGBR", "PID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  Constraints for Table TERET
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TERET" ADD CONSTRAINT "PKTERET" PRIMARY KEY ("POSILJKA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."TERET" MODIFY ("POSILJKA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table STAVKARAC
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKARAC" ADD CONSTRAINT "PKSTRAC" PRIMARY KEY ("STAVKAR", "BRRAC")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."STAVKARAC" MODIFY ("STAVKAR" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKARAC" MODIFY ("BRRAC" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ULICA" ADD CONSTRAINT "PKULICA" PRIMARY KEY ("RBULICE", "RBMESTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."ULICA" MODIFY ("RBULICE" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ULICA" MODIFY ("RBMESTA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MESTO" ADD CONSTRAINT "PKMEST" PRIMARY KEY ("RBMESTA", "DRZID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."MESTO" MODIFY ("RBMESTA" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."MESTO" MODIFY ("DRZID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DRZAVA" ADD CONSTRAINT "PKDRZAVA" PRIMARY KEY ("DRZID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."DRZAVA" MODIFY ("DRZID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."KLIJENT" MODIFY ("PIB" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."KLIJENT" ADD CONSTRAINT "SYS_C0011058" PRIMARY KEY ("KID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."KLIJENT" MODIFY ("NAZIVFIRME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VOZILO" ADD CONSTRAINT "PKVOZILO" PRIMARY KEY ("REGBR", "PID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."VOZILO" MODIFY ("REGBR" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAVKAOTPR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKAOTPR" ADD CONSTRAINT "PKSTOTPR" PRIMARY KEY ("STAVKAO", "OTPRBR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."STAVKAOTPR" MODIFY ("STAVKAO" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKAOTPR" MODIFY ("OTPRBR" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKAOTPR" MODIFY ("ROBAID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SKLADISTE" ADD CONSTRAINT "PKSKLAD" PRIMARY KEY ("SKLADRB")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."SKLADISTE" MODIFY ("SKLADRB" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table NALOGZAUSKLADISTENJE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" ADD CONSTRAINT "PKNALZAUSKL" PRIMARY KEY ("BRNAL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" MODIFY ("BRNAL" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" MODIFY ("RID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" MODIFY ("SKLADRB" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" MODIFY ("UGID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table STAVKANALTR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKANALTR" ADD CONSTRAINT "STAVKANALTTR_PK" PRIMARY KEY ("STAVKANT", "NALID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."STAVKANALTR" MODIFY ("STAVKANT" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKANALTR" MODIFY ("NALID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ROBA" ADD CONSTRAINT "PKROBA" PRIMARY KEY ("ROBAID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
--  Constraints for Table STAVKANALTR_DETALJI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKANALTR_DETALJI" ADD CONSTRAINT "STAVKANALTR_DETALJI_PK" PRIMARY KEY ("STAVKANT", "NALID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."STAVKANALTR_DETALJI" MODIFY ("STAVKANT" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKANALTR_DETALJI" MODIFY ("NALID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table PREVOZNIK
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PREVOZNIK" ADD CONSTRAINT "PKPREV" PRIMARY KEY ("PID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."PREVOZNIK" MODIFY ("PID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."KONTAKTOSOBA" ADD CONSTRAINT "KOSOBA_PK" PRIMARY KEY ("KID", "KONTAKTRB")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."KONTAKTOSOBA" MODIFY ("KID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."KONTAKTOSOBA" MODIFY ("KONTAKTRB" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."RADNIK" ADD CONSTRAINT "PKRADNIK" PRIMARY KEY ("RID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  
  ALTER TABLE "SYSTEM"."RADNIK" MODIFY ("RID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."RACUN" ADD CONSTRAINT "PKRACUN" PRIMARY KEY ("BRRAC")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."RACUN" MODIFY ("BRRAC" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table TRANSPORTNIUGOVOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" ADD CONSTRAINT "PKTRUG" PRIMARY KEY ("UGID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" MODIFY ("UGID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" MODIFY ("RID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" MODIFY ("PID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" MODIFY ("NALID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ADRESA" ADD CONSTRAINT "PKADRESA" PRIMARY KEY ("RBADRESE", "RBULICE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."ADRESA" MODIFY ("RBULICE" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."ADRESA" MODIFY ("RBADRESE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Constraints for Table NALOGZATRANSPORT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" ADD CONSTRAINT "PKNALZATR" PRIMARY KEY ("NALID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" MODIFY ("NALID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" MODIFY ("RID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" MODIFY ("KID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" MODIFY ("POSILJKA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Constraints for Table STAVKATERET
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKATERET" ADD CONSTRAINT "PKSTTERET" PRIMARY KEY ("STAVKAT", "POSILJKA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."STAVKATERET" MODIFY ("STAVKAT" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKATERET" MODIFY ("POSILJKA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table STAVKATRUG
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKATRUG" ADD CONSTRAINT "PKSTTRUG" PRIMARY KEY ("STAVKATU", "UGID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
 
  ALTER TABLE "SYSTEM"."STAVKATRUG" MODIFY ("STAVKATU" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKATRUG" MODIFY ("UGID" NOT NULL ENABLE);
 
  ALTER TABLE "SYSTEM"."STAVKATRUG" MODIFY ("ROBAID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_ROLLUP" ADD CONSTRAINT "MVIEW$_ADV_ROLLUP_PFK" FOREIGN KEY ("RUNID#", "PLEVELID#")
	  REFERENCES "SYSTEM"."MVIEW$_ADV_LEVEL" ("RUNID#", "LEVELID#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table NALOGZATRANSPORT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" ADD CONSTRAINT "FKNALZATRAN" FOREIGN KEY ("RID")
	  REFERENCES "SYSTEM"."RADNIK" ("RID") ENABLE;
 
  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" ADD CONSTRAINT "FKNALZATRAN2" FOREIGN KEY ("KID")
	  REFERENCES "SYSTEM"."KLIJENT" ("KID") ENABLE;
 
  ALTER TABLE "SYSTEM"."NALOGZATRANSPORT" ADD CONSTRAINT "FKNALZATRAN3" FOREIGN KEY ("POSILJKA")
	  REFERENCES "SYSTEM"."TERET" ("POSILJKA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table NALOGZAUSKLADISTENJE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" ADD CONSTRAINT "FKNALZAUSKL" FOREIGN KEY ("RID")
	  REFERENCES "SYSTEM"."RADNIK" ("RID") ENABLE;
 
  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" ADD CONSTRAINT "FKNALZAUSKL2" FOREIGN KEY ("SKLADRB")
	  REFERENCES "SYSTEM"."SKLADISTE" ("SKLADRB") ENABLE;
 
  ALTER TABLE "SYSTEM"."NALOGZAUSKLADISTENJE" ADD CONSTRAINT "FKNALZAUSKL3" FOREIGN KEY ("UGID")
	  REFERENCES "SYSTEM"."TRANSPORTNIUGOVOR" ("UGID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PREVOZNIK
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PREVOZNIK" ADD CONSTRAINT "FKPREVOZNIK" FOREIGN KEY ("RBADRESE", "RBULICE")
	  REFERENCES "SYSTEM"."ADRESA" ("RBADRESE", "RBULICE") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table RACUN
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."RACUN" ADD CONSTRAINT "FK_RACUN" FOREIGN KEY ("KID")
	  REFERENCES "SYSTEM"."KLIJENT" ("KID") ENABLE;
...
--------------------------------------------------------
--  Ref Constraints for Table ROBA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ROBA" ADD CONSTRAINT "FKROBA" FOREIGN KEY ("STAVKAT", "POSILJKA")
	  REFERENCES "SYSTEM"."STAVKATERET" ("STAVKAT", "POSILJKA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table STAVKANALTR_DETALJI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKANALTR_DETALJI" ADD CONSTRAINT "FK_STAVKANLTR_DETALJI" FOREIGN KEY ("RBULICE", "RBMESTA")
	  REFERENCES "SYSTEM"."ULICA" ("RBULICE", "RBMESTA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table STAVKAOTPR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKAOTPR" ADD CONSTRAINT "FKSTOTPR" FOREIGN KEY ("ROBAID")
	  REFERENCES "SYSTEM"."ROBA" ("ROBAID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table STAVKATRUG
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."STAVKATRUG" ADD CONSTRAINT "FKSTTRUG" FOREIGN KEY ("ROBAID")
	  REFERENCES "SYSTEM"."ROBA" ("ROBAID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TRANSPORTNIUGOVOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" ADD CONSTRAINT "FKTRANSUGOVOR" FOREIGN KEY ("RID")
	  REFERENCES "SYSTEM"."RADNIK" ("RID") ENABLE;
 
  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" ADD CONSTRAINT "FKTRANSUGOVOR2" FOREIGN KEY ("PID")
	  REFERENCES "SYSTEM"."PREVOZNIK" ("PID") ENABLE;
 
  ALTER TABLE "SYSTEM"."TRANSPORTNIUGOVOR" ADD CONSTRAINT "FKTRANSUGOVOR3" FOREIGN KEY ("NALID")
	  REFERENCES "SYSTEM"."NALOGZATRANSPORT" ("NALID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TRG_AD_RACUN
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AD_RACUN" 
after delete on racun 
for each row
declare
begin
delete from stavkarac where brrac =:old.brrac;
end;
/
ALTER TRIGGER "SYSTEM"."TRG_AD_RACUN" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AUID_SUMASTAVKI_2
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AUID_SUMASTAVKI_2" after insert or update or delete on stavkarac
for each row declare
rac stavkar.brrac%TYPE;
l_ukupnacena racun.ukupnacena%type;
l_cena stavkarac.cena%type;
l_suma racun.ukupnacena%type;
l_pocetna racun.ukupnacena%type;
pragma autonomous_transaction;
begin

if inserting then begin
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_RACUN DISABLE';
stavkar.brrac := :new.brrac;
rac := :new.brrac;
l_cena := :new.cena;
select ukupnacena into l_ukupnacena from racun where brrac = rac;
sumastavkiracuna1(rac, l_ukupnacena, l_cena, l_suma);
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_RACUN ENABLE';
end; end if; 
...
stavkar.brrac := :new.brrac;
rac := :new.brrac;
l_cena := :old.cena - :new.cena;
select ukupnacena into l_ukupnacena from racun where brrac = rac;
sumastavkiracuna2(rac, l_ukupnacena, l_cena, l_suma);
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_RACUN ENABLE';
end; end if;

if deleting then begin
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_RACUN DISABLE';
stavkar.brrac := :old.brrac;
rac := :old.brrac;
l_cena := :old.cena;
select ukupnacena into l_ukupnacena from racun where brrac = rac;
sumastavkiracuna3(rac, l_ukupnacena, l_cena, l_suma);
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_RACUN ENABLE';
end; end if;
end;
/
ALTER TRIGGER "SYSTEM"."TRG_AUID_SUMASTAVKI_2" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AUTO_INCREMENT_KLIJENT
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_KLIJENT" 
  BEFORE INSERT ON KLIJENT
  FOR EACH ROW
BEGIN
  SELECT auto_increment_klijent.nextval
    INTO :new.kid
    FROM dual;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_KLIJENT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AUTO_INCREMENT_MESTO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_MESTO" 
  BEFORE INSERT ON MESTO
  FOR EACH ROW
BEGIN
  SELECT auto_increment_mesto.nextval
    INTO :new.rbmesta
    FROM dual;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_MESTO" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AUTO_INCREMENT_RADNIK
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_RADNIK" 
  BEFORE INSERT ON RADNIK
  FOR EACH ROW
BEGIN
  SELECT auto_increment_radnik.nextval
    INTO :new.rid
    FROM dual;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_RADNIK" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AUTO_INCREMENT_ULICA
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_ULICA" 
  BEFORE INSERT ON ULICA
  FOR EACH ROW
BEGIN
  SELECT auto_increment_ulica.nextval
    INTO :new.rbulice
    FROM dual;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_AUTO_INCREMENT_ULICA" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AU_KLIJENT
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AU_KLIJENT" 
AFTER UPDATE OF NazivFirme ON Klijent 
FOR EACH ROW
DECLARE
PRAGMA AUTONOMOUS_TRANSACTION;
BEGIN 
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_NalogZaTransport DISABLE';
UPDATE NalogZaTransport
SET NazivFirme = :new.NazivFirme
WHERE Kid = :new.Kid;
COMMIT;
BEGIN
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_NalogZaTransport ENABLE';
END;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_AU_KLIJENT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AU_KLIJENT_RACUN
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AU_KLIJENT_RACUN" 
AFTER UPDATE OF NazivFirme ON Klijent 
FOR EACH ROW
DECLARE
PRAGMA AUTONOMOUS_TRANSACTION;
...
END;
/
ALTER TRIGGER "SYSTEM"."TRG_AU_KLIJENT_RACUN" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AU_MESTO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AU_MESTO" 
after update of NazivM on Mesto
for each row
declare
pragma autonomous_transaction;
begin
execute immediate 'alter trigger TRG_BU_ULICA disable';
update ulica
set NazivM =:new.NazivM where RbMesta = :new.RbMesta;
commit;
begin
execute immediate 'alter trigger TRG_BU_ULICA enable';
end; end;
/
ALTER TRIGGER "SYSTEM"."TRG_AU_MESTO" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_AU_NALOGZATRANSPORT
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_AU_NALOGZATRANSPORT" 
AFTER UPDATE OF NazivFirme ON nalogzatransport 
FOR EACH ROW
DECLARE
PRAGMA AUTONOMOUS_TRANSACTION;
BEGIN 
...
UPDATE NalogZaTransport
SET kid = :new.kid
WHERE nazivfirme = :new.nazivfirme;
COMMIT;
BEGIN
EXECUTE IMMEDIATE 'ALTER TRIGGER TRG_BU_NalogZaTransport ENABLE';
END;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_AU_NALOGZATRANSPORT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_BD_RACUN
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_BD_RACUN" 
...
/
ALTER TRIGGER "SYSTEM"."TRG_BD_RACUN" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_BIUD_SUMASTAVKI
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_BIUD_SUMASTAVKI" before insert or update or delete on Racun
for each row
begin
...
/
ALTER TRIGGER "SYSTEM"."TRG_BIUD_SUMASTAVKI" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_BI_NALOGZATRANSPORT
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_BI_NALOGZATRANSPORT" 
BEFORE INSERT ON NalogZaTransport
FOR EACH ROW
DECLARE
I_NazivFirme varchar2(20);
BEGIN
SELECT NazivFirme INTO I_NazivFirme FROM Klijent
WHERE Kid = :new.Kid;
:new.NazivFirme := I_NazivFirme;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_BI_NALOGZATRANSPORT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_BI_ULICA
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_BI_ULICA" 
BEFORE INSERT ON Ulica
FOR EACH ROW
DECLARE
I_NazivM varchar2(20);
BEGIN
SELECT NazivM INTO I_NazivM FROM MESTO
WHERE RbMesta = :new.RbMesta;
:new.NazivM := I_NazivM;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_BI_ULICA" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_BU_NALOGZATRANSPORT
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_BU_NALOGZATRANSPORT" 
BEFORE UPDATE OF NAZIVFIRME ON NALOGZATRANSPORT
BEGIN
IF UPDATING THEN
RAISE_APPLICATION_ERROR (-20503, 'Nije dozvoljeno menjati vrednosti!');
END IF;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_BU_NALOGZATRANSPORT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_BU_RACUN
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_BU_RACUN" 
BEFORE UPDATE OF UKUPNACENA ON RACUN
BEGIN
IF UPDATING THEN
RAISE_APPLICATION_ERROR (-20503, 'Nije dozvoljeno menjati vrednosti!');
END IF;
END;
/
ALTER TRIGGER "SYSTEM"."TRG_BU_RACUN" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_BU_ULICA
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_BU_ULICA" 
before update of NazivM on Ulica
begin
if updating then
raise_application_error (-20503, 'Nije dozvoljeno menjati vrednosti!');
end if; end;
/
ALTER TRIGGER "SYSTEM"."TRG_BU_ULICA" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_IO_STAVKANALTR_VIEW
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."TRG_IO_STAVKANALTR_VIEW" instead of insert or update or delete on stavkanaltr_view
referencing new as n old as old
for each row declare
begin

if inserting then begin
insert into StavkaNalTr (stavkaNT, nalID, kontaktUtov, kontaktIstov) 
      values (:n.stavkaNT, :n.nalId, :n.kontaktUtov, :n.kontaktIstov);
insert into stavkanaltr_detalji (stavkant, nalid, osiguranje, robaid, rbulice, rbmesta)
      values (:n.stavkant, :n.nalid, :n.osiguranje, :n.robaid, :n.rbulice, :n.rbmesta);
end; end if; 

if updating then begin
update StavkaNalTr set StavkaNalTr.kontaktUtov = :n.kontaktUtov, StavkaNalTr.kontaktIstov = :n.kontaktIstov
      where stavkaNalTr.nalId = :old.nalId and stavkaNalTr.stavkaNT = :old.stavkaNT;
update stavkanaltr_detalji set stavkanaltr_detalji.osiguranje = :n.osiguranje, stavkanaltr_detalji.robaid = :n.robaid, stavkanaltr_detalji.rbulice = :n.rbulice, stavkanaltr_detalji.rbmesta = :n.rbmesta
      where stavkanaltr_detalji.stavkant = :old.stavkant and stavkanaltr_detalji.nalid = :old.nalid;
end; end if;

if deleting then begin
delete from stavkanaltr where stavkanaltr.nalid = :old.nalid and stavkaNalTr.stavkaNT = :old.stavkaNT;
delete from stavkanaltr_detalji where stavkanaltr_detalji.nalid = :old.nalid and stavkanaltr_detalji.stavkant = :old.stavkant;
end; end if;
end;
/
ALTER TRIGGER "SYSTEM"."TRG_IO_STAVKANALTR_VIEW" ENABLE;
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Package RADNIKPOZ
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE "SYSTEM"."RADNIKPOZ" IS
rid Number;
END;

/
--------------------------------------------------------
--  DDL for Package STAVKAR
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE "SYSTEM"."STAVKAR" IS
brrac Number;
END;
...
/
--------------------------------------------------------
--  DDL for Procedure SUMASTAVKIRACUNA1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."SUMASTAVKIRACUNA1" (
rac in stavkar.brrac%type, 
l_ukupnacena in racun.ukupnacena%type, 
l_cena in stavkarac.cena%type, 
l_suma out racun.ukupnacena%type)
as
begin
l_suma := l_ukupnacena + l_cena;
update racun
set ukupnacena = l_suma
where brrac = rac;
end;

/
--------------------------------------------------------
--  DDL for Procedure SUMASTAVKIRACUNA2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."SUMASTAVKIRACUNA2" (
rac in stavkar.brrac%type, 
l_ukupnacena in racun.ukupnacena%type, 
l_cena in stavkarac.cena%type, 
l_suma out racun.ukupnacena%type)
...
/
--------------------------------------------------------
--  DDL for Procedure SUMASTAVKIRACUNA3
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."SUMASTAVKIRACUNA3" (
rac in stavkar.brrac%type, 
l_ukupnacena in racun.ukupnacena%type, 
l_cena in stavkarac.cena%type, 
l_suma out racun.ukupnacena%type)
